                ...
                <form action="/appointment" method="post">
                 @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" name="day" class="form-control" value="{{old('day')}}" placeholder="يوم الكشف">
                      @error('day')
                        <small id="helpId" class="text-muted">{{$message}}</small>
                      @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="time" name="time" class="form-control" value="{{old('time')}}" placeholder="ساعة الكشف">
                        @error('time')
                          <small id="helpId" class="text-muted">{{$message}}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="price" class="form-control" value="{{old('price')}}" placeholder="سعر الكشف">
                        @error('price')
                          <small id="helpId" class="text-muted">{{$message}}</small>
                        @enderror
                    </div>
