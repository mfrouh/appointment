...
<div class="card">
    <div class="card-body">
        ...
        <div class="row form-row">
            <div class="col-md-12">
                <form action="/speciality/{{$speciality->id}}" method="post"  enctype="multipart/form-data">
                 @csrf
                 @method('put')
                <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="active" class="form-control">
                            <option value="0" {{$speciality->active=='0'?'selected':''}}>مغلق</option>
                            <option value="1" {{$speciality->active=='1'?'selected':''}}>مفعل</option>
                        </select>
                    </div>
                    @error('active')
                         <span class="mute"> {{$message}}</span>
