...
Route::get('/dashboard','Backend\DashboardController@index')->middleware('Dashboard');
...
Route::get('/clinic/{id}',function(){return abort(404);});
});
Auth::routes();
